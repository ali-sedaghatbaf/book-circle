  ...
  return (
    <div className="space-y-12">
        {isLoading ? (
            ...
            <>
                <BookCarousel title={t('forYou')} books={forYouBooks} />
                <BookCarousel title={t('recentlyAdded')} books={recentlyAdded} />
            </>
        )}
      ...
      <section className="space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="space-y-1">
                <h2 className="text-2xl font-bold font-headline">{t('exploreTitle')}</h2>
        ...
        {isLoading ? (
            ...
            <AllBooksGrid books={filteredBooks} noBooksMessage={t('noBooksFound')} />
        )}
      </section>
    </div>
  );
